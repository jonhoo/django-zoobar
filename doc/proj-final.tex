...
The second repository contains out modifications to the Lab 3 concolic
execution framework to support Django applications, as well as a
testing script for the ported zoobar application.


Changes of particular interest are
